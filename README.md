...
5. publishes a `NoPromotion` GitHub release with the Windows ZIP, corresponding patched source archive, and SHA-256 hashes.
...
v2rayN is developed by 2dust and is licensed under GPL-3.0. These are unofficial custom builds. Each custom release identifies the exact upstream release used and includes the corresponding patched source archive.
